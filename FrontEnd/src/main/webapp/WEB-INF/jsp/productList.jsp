...
<body>
	...
	<div class="container">
		...
		<table class="table table-hover" id="product" class="display"
			...
			<c:forEach var="c" varStatus="st" items="${productList}">
				<tr>
					...
					<td><img
						src="${pageContext.request.contextPath}/resources/images/<c:out value='${c.imgName}'></c:out>" /></td>

					<td><a class="btn btn-info" role="button"
						href="<c:url value="deleteProduct/${c.productID}" />">Delete</a> <a
						class="btn btn-info" role="button"
						href="<c:url value="updateProduct/${c.productID}"/>">Update</a></td>
				</tr>
			</c:forEach>
		</table>
